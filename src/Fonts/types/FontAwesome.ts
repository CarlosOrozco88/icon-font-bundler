...
export default {
  async build(
    ...
    // await this.checkVersion(oFontOptions, oFontConfig);
  ...
  // async checkVersion(oFontOptions: IconFontBundlerFontConfig, oFontConfig: IconFontBundlerItem) {
  //   if (!oFontConfig.font.version) {
  //     oFontConfig.font.version = 'master';
  //   }
  //   const sBaseUrl = `https://api.github.com/repos/FortAwesome/Font-Awesome/branches`;
  //   const branchesFA = await Utils.fetchFile(sBaseUrl);
  //   console.log(branchesFA);
  // },
};
